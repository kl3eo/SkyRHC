...
fn polkadot_staging_testnet_config_genesis(wasm_binary: &[u8]) -> pirl::GenesisConfig {
	...
	pirl::GenesisConfig {
		frame_system: pirl::SystemConfig {
			code: wasm_binary.to_vec(),
			changes_trie_config: Default::default(),
		},
		pallet_balances: pirl::BalancesConfig {
		...
		pallet_indices: pirl::IndicesConfig { indices: vec![] },
		pallet_session: pirl::SessionConfig {
		...
		pallet_staking: pirl::StakingConfig {
			validator_count: 50,
		...
		pallet_collective_Instance1: pirl::CouncilConfig {
			members: vec![],
			phantom: Default::default(),
		},
		pallet_collective_Instance2: pirl::TechnicalCommitteeConfig {
			members: vec![],
			phantom: Default::default(),
		},
		pallet_membership_Instance1: Default::default(),
		pallet_babe: pirl::BabeConfig {
			authorities: Default::default(),
			epoch_config: Some(pirl::BABE_GENESIS_EPOCH_CONFIG),
		},
		pallet_grandpa: Default::default(),
		pallet_im_online: Default::default(),
		pallet_authority_discovery: pirl::AuthorityDiscoveryConfig { keys: vec![] },
		claims: pirl::ClaimsConfig {
			claims: vec![],
			vesting: vec![],
		},
		pallet_vesting: pirl::VestingConfig { vesting: vec![] },
		pallet_treasury: Default::default(),
                //pallet_sudo: Some(pirl_runtime::SudoConfig {
...
pub fn polkadot_testnet_genesis(
	...
	pirl::GenesisConfig {
		...
		pallet_elections_phragmen: Default::default(),
		pallet_democracy: pirl::DemocracyConfig::default(),
		pallet_collective_Instance1: pirl::CouncilConfig {
			members: vec![],
			phantom: Default::default(),
		},
		...
		pallet_vesting: pirl::VestingConfig { vesting: vec![] },
		pallet_treasury: Default::default(),
		//pallet_sudo: Some(pirl_runtime::SudoConfig { key: _root_key }),
	}
}
...
pub fn polkadot_local_testnet_config() -> Result<PolkadotChainSpec, String> {
	let wasm_binary = pirl::WASM_BINARY.ok_or("Polkadot development wasm not available")?;
