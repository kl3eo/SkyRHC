...
export function createProduction (t: TFunction): LinkOption[] {
  return expandEndpoints(t, [
    ...
    {
      info: 'skypirl',
      text: t('rpc.skypirl', 'SkyPirl', { ns: 'apps-config' }),
      providers: {
        'Room-House': 'wss://cube.room-house.com:8466/'
      }
    },
/*
    {
      info: 'pirl',
      text: t('rpc.pirl', 'Pirl', { ns: 'apps-config' }),
      providers: {
        'Room-House': 'wss://cube.room-house.com:8402/'
      }
    },
*/
    {
